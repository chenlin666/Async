	...
	switch (mode) {
		...
		case 'agent':
			return [
				...
				'2. Make changes using **Edit** (for targeted edits) or **Write** (for new files or full rewrites).',
