...
export const messagesEn: Record<string, string> = {
	...
	'settings.appearance.fontDesc': 'Control the typography used across the Async interface. Apple System is the default and now matches the Claude Code-style look more closely.',
	...
	'settings.appearance.previewBody': 'Async keeps the UI clean and readable while staying close to the Claude Code layout language.',
	...
	'agentBehavior.shellComposerHint':
		'Matches the composer’s three-way “command permission” control. “Allow within rules”: explicit allow rules or the low-risk allowlist can skip prompts. “Ask every time”: every Bash needs confirmation (even allow rules). Fine-grained rules are below. Session memory extraction is under Settings → “Code Indexing & Memory”.',
	...
	'agentBehavior.memoryExtractionDesc':
		'Throttles background extraction into `.async/memory` (similar to Claude Code SessionMemory). Turn off to stop queueing extractions.',
	...
	'settings.indexing.symbolIndexDesc': 'Powers Quick Open @ and Grep (symbol mode).',
