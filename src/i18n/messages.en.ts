...
export const messagesEn: Record<string, string> = {
	...
	'slashCmd.createRuleDesc': 'Guide writing a Rule in Async: pick scope (always / glob / manual @) with a built-in system brief.',
	'slashCmd.createSubagentDesc': 'Guide writing a Subagent: pick user-level or this project with a built-in system brief.',
	...
	'ruleWizard.desc': 'Choose how the rule is injected; the assistant will follow Async Rules workflow.',
	...
	'subagentWizard.scopeDesc': 'The assistant will tailor paths and settings advice to this choice.',
