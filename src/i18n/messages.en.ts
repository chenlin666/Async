...
export const messagesEn: Record<string, string> = {
	...
	'settings.modelsHint':
		'Add models below: display name for UI, request name as the API model id, paradigm selects the protocol. Keys use Global defaults unless you enable a per-model endpoint under Advanced.',
