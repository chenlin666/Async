...
export const messagesZhCN: Record<string, string> = {
	...
	'slashCmd.createSubagentDesc': '创建 Subagent：选范围后走 Agent，尽量写入 .async/agent.json 等配置。',
	...
	'subagentWizard.scopeDesc': '选择后自动切到 Agent；有工作区时助手会用工具写入子代理配置，而非只输出可复制文本。',
