...
export const messagesZhCN: Record<string, string> = {
	...
	'slashCmd.createRuleDesc': '引导在 Async 中编写 Rule：选择作用域（始终 / Glob / 手动 @）并注入内置系统说明。',
	'slashCmd.createSubagentDesc': '引导编写 Subagent：选择用户级或本项目，并注入内置系统说明。',
	...
	'ruleWizard.desc': '选择规则如何注入到对话中；确认后助手会按 Async Rules 流程引导你完成正文。',
	...
	'subagentWizard.scopeDesc': '选择后，助手会按范围给出落盘路径与设置建议。',
